{{-- <div class="space-y-5">
    ...
    <section class="bg-gray-50 dark:bg-gray-900 flex w-full items-center">
        <div class="mx-auto w-full">
            <!-- Start coding here -->
            <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div
                    class="flex flex-col p-4 space-y-3 justify-between w-full md:flex-row md:items-center md:space-x-4 md:space-y-0">
                    <div class="w-full md:w-1/2">
                        <x-input.text livewire='search' placeholder='Search name...' class="mb-0"/>
                    </div>
                    <div class="flex justify-end md:justify-center w-full space-x-3 md:w-auto">
                        <x-input.select toggle="roleDropdown" title="Select Role" :livewire="[
                            'All' => 'filterRole(\'\')',
                            'Admin' => 'filterRole(\'admin\')',
                            'Parent' => 'filterRole(\'parent\')',
                            'Teacher' => 'filterRole(\'teacher\')',
                        ]" />
                        <x-button class="h-fit" title="Tambah" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <table class="w-full text-sm overflow-y-auto text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-fontPrimary-neutral uppercase border-b bg-gray-100">
            <tr>
                <x-table.head message='Nama' left='true' />
                <x-table.head message='Email' />
                <x-table.head message='Role' right='true' />
            </tr>
        </thead>
        <tbody>
            @foreach ($users as $user)
                <x-table.row>
                    <x-table.cell class="font-medium text-fontPrimary-active">{{ $user->name }}</x-table.cell>
            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div
                    ...
                    <div
                        ...
                        <x-filter.search name="search-user" placeholder="Search users"/>
